...
public class Utils {
    ...
    public String getPluginDescription() {
        return StringUtils.colorize(plugin.getMainConfig().PREFIX() + "&eThis server is running &bBungeeCore &b" + plugin.getDescription().getVersion() + " &eby &b" + plugin.getDescription().getAuthor());
    }
    ...
    public boolean checkPermission(CommandSender target, String permission, boolean others, boolean showPermission, @Nullable String command) {
        permission = "bungeecore." + permission.toLowerCase();
