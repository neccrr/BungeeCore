package dev.necr.bungeecore.managers;

import dev.necr.bungeecore.BungeeCore;
import dev.necr.bungeecore.utils.StringUtils;
import dev.necr.bungeecore.callbacks.CanSkipCallback;
...
public class ConfirmationManager {
    ...
    public void requestConfirmation(Callable callable, CommandSender sender, boolean skip, @Nullable List<String> warnings) {
        if (!skip || sender instanceof ProxiedPlayer) {
            ...
            player.sendMessage(new TextComponent(plugin.getMainConfig().PREFIX() + StringUtils.colorize("&ePlease type &b/bungeecore confirm &eto confirm your action.")));
